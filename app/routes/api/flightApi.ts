...
import FlightController from '../../controllers/Flight/flightController';
...
class FlightApi {
  ...
  routes() {
     ...
     */
    this.router.get('/', FlightController.list); // /api/books READ
     ...
     */
    this.router.post('/', AuthMiddleware.authorizeAdmin, FlightController.create);
