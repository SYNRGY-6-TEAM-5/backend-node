...
class AirlineController implements IRestController {
  ...
  async show(req: Request, res: Response) {
    try {
      ...
      const airport = await AirlineService.get(parseInt(airport_id, 10));
  ...
  async create(req: IRequestWithAuth, res: Response, next: NextFunction) {
    try {
      ...
      AirlineService.setUser = userDetails;

      const result = await AirlineService.create(req.body as ICar);
  ...
  async update(req: IRequestWithAuth, res: Response, next: NextFunction) {
    try {
      ...
      const result = await AirlineService.update(parseInt(id, 10), req.body as ICar);
